...
public class jtownOutbound extends AppCompatActivity
        implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_jtown_outbound);
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        map.setOnMarkerClickListener(new GoogleMap.OnMarkerClickListener() {
            ...
            public boolean onMarkerClick(Marker marker) {
                ...
                gps = new LocationTracker(jtownOutbound.this);
    ...
    private void makeJsonObReq() {
        ...
        pDialog.setTitle("563 City Centre - Jordanstown"); // Setting Title
            ...
            public void onResponse(JSONObject response) {
                ...
                try {
                    ...
                    for (int i = 0; i < feat.length(); i++) { // JSON Array within the object request which loops through each feature object
                        ...
                        if (li == 15209.000000 || li == 1395.000000 || li == 530.000000 || li == 1331.000000 || li == 3493.000000 || li == 3573.000000 || li == 15088.000000) {
