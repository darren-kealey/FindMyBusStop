...
public class sevenAOutbound extends AppCompatActivity
        implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_seven_aoutbound);
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        map.setOnMarkerClickListener(new GoogleMap.OnMarkerClickListener() {
            ...
            public boolean onMarkerClick(Marker marker) {
                ...
                gps = new LocationTracker(sevenAOutbound.this);
    ...
    private void makeJsonObReq() {
        ...
        pDialog.setTitle("7a - City Centre to Four Winds "); // Setting Title
            ...
            public void onResponse(JSONObject response) {
                ...
                try {
                    ...
                    for (int i = 0; i < feat.length(); i++) { // JSON Array within the object request which loops through each feature object
                        ...
                        if (li == 309.000000 || li == 301.000000 || li == 299.000000 || li == 297.000000 || li == 295.000000 || li == 293.000000 || li == 291.000000 || li == 287.000000 || li == 285.000000
                                || li == 283.000000 || li == 281.000000|| li == 277.000000 || li == 1601.000000 || li == 1599.000000 || li == 1597.000000 || li == 15996.000000) {
