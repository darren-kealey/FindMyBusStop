...
public class sevenAInward extends AppCompatActivity
        implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_seven_ainward);
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        map.setOnMarkerClickListener(new GoogleMap.OnMarkerClickListener() {
            ...
            public boolean onMarkerClick(Marker marker) {
                ...
                gps = new LocationTracker(sevenAInward.this);
    ...
    private void makeJsonObReq() {
        ...
        pDialog.setTitle("7a - Four Winds to City Centre"); // Setting Title
            ...
            public void onResponse(JSONObject response) {
                ...
                try {
                    ...
                    for (int i = 0; i < feat.length(); i++) { // JSON Array within the object request which loops through each feature object
                        ...
                        if (li == 408.000000 || li == 410.000000 || li == 412.000000 || li == 414.000000 || li == 416.000000 || li == 418.000000 || li == 420.000000 || li == 422.000000 || li == 432.000000
                                || li == 434.000000 || li == 436.000000|| li == 15470.000000 || li == 440.000000 || li == 442.000000 || li == 1602.000000 || li == 1599.000000 || li == 14929.000000) {
